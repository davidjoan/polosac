...
function link_to1($name, $internal_uri, $options = array())
{
  ...
  $html_options = array_merge(array('href' => $html_options['href']), $html_options); // SEO requirement | 2010-07-13
 ...
 * @see    url_for, link_to
 * 
 * @update To support button tag instead of input | 2010-07-19
 */
function button_to($name, $internal_uri, $options = array())
{
  ...
  $url = "'".$url."'";
  $html_options['type'] = isset($html_options['type']) ? $html_options['type'] : 'button';
